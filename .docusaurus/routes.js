...
export default [
  {
    ...
    component: ComponentCreator('/__docusaurus/debug', '59c'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/config',
    component: ComponentCreator('/__docusaurus/debug/config', 'ce9'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/content',
    component: ComponentCreator('/__docusaurus/debug/content', '4f5'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/globalData',
    component: ComponentCreator('/__docusaurus/debug/globalData', '560'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/metadata',
    component: ComponentCreator('/__docusaurus/debug/metadata', 'eb5'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/registry',
    component: ComponentCreator('/__docusaurus/debug/registry', '7ad'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/routes',
    component: ComponentCreator('/__docusaurus/debug/routes', 'fc2'),
    exact: true
  },
  {
    path: '/about',
    component: ComponentCreator('/about', 'cf0'),
    exact: true
  },
  {
    path: '/blog',
    component: ComponentCreator('/blog', 'e57'),
    exact: true
  },
  {
    path: '/blog/archive',
    component: ComponentCreator('/blog/archive', '9e3'),
    exact: true
  },
  {
    path: '/blog/constructing-a-3d-egg-shape-from-regular-polygons',
    component: ComponentCreator('/blog/constructing-a-3d-egg-shape-from-regular-polygons', '589'),
    exact: true
  },
  {
    path: '/blog/creating-3d-buildings-from-mastermap-with-qgis',
    component: ComponentCreator('/blog/creating-3d-buildings-from-mastermap-with-qgis', 'ebb'),
    exact: true
  },
  {
    path: '/blog/designing-a-living-building:-an-organism-with-a-symbiotic-relationship-with-its-occupants',
    component: ComponentCreator('/blog/designing-a-living-building:-an-organism-with-a-symbiotic-relationship-with-its-occupants', '9ad'),
    exact: true
  },
  {
    path: '/blog/designing-for-comfort-and-practicality-in-motor-caravans',
    component: ComponentCreator('/blog/designing-for-comfort-and-practicality-in-motor-caravans', '0ca'),
    exact: true
  },
  {
    path: '/blog/designing-hardware-for-mounting-wireless-hardware-equiptment-on-marquees',
    component: ComponentCreator('/blog/designing-hardware-for-mounting-wireless-hardware-equiptment-on-marquees', '8e8'),
    exact: true
  },
  {
    path: '/blog/exploring-the-unique-characteristics-of-natural-building-materials',
    component: ComponentCreator('/blog/exploring-the-unique-characteristics-of-natural-building-materials', '127'),
    exact: true
  },
  {
    path: '/blog/flood-risk-assessment-of-pudding-brook',
    component: ComponentCreator('/blog/flood-risk-assessment-of-pudding-brook', '3c0'),
    exact: true
  },
  {
    path: '/blog/gifford-circus-cry-wheel-performances',
    component: ComponentCreator('/blog/gifford-circus-cry-wheel-performances', 'a05'),
    exact: true
  },
  {
    path: '/blog/inspire-index-polygon-house-prices',
    component: ComponentCreator('/blog/inspire-index-polygon-house-prices', 'fd2'),
    exact: true
  },
  {
    path: '/blog/live-network-map-for-womad-festival',
    component: ComponentCreator('/blog/live-network-map-for-womad-festival', 'a20'),
    exact: true
  },
  {
    path: '/blog/mapping-wireless-coverage-at-the-royal-windsor-horse-show-with-arcgis',
    component: ComponentCreator('/blog/mapping-wireless-coverage-at-the-royal-windsor-horse-show-with-arcgis', 'd0e'),
    exact: true
  },
  {
    path: '/blog/modeling-a-spherical-solar-concentrator',
    component: ComponentCreator('/blog/modeling-a-spherical-solar-concentrator', 'bf7'),
    exact: true
  },
  {
    path: '/blog/page/2',
    component: ComponentCreator('/blog/page/2', 'ca6'),
    exact: true
  },
  {
    path: '/blog/parish-house-prices',
    component: ComponentCreator('/blog/parish-house-prices', 'b2a'),
    exact: true
  },
  {
    path: '/blog/provisioning-cisco-cloud-wireless-controller',
    component: ComponentCreator('/blog/provisioning-cisco-cloud-wireless-controller', '4fb'),
    exact: true
  },
  {
    path: '/blog/tags',
    component: ComponentCreator('/blog/tags', '226'),
    exact: true
  },
  {
    path: '/blog/tags/docusaurus',
    component: ComponentCreator('/blog/tags/docusaurus', '80f'),
    exact: true
  },
  {
    path: '/blog/tags/docusaurus/page/2',
    component: ComponentCreator('/blog/tags/docusaurus/page/2', 'f81'),
    exact: true
  },
  {
    path: '/blog/tags/hello',
    component: ComponentCreator('/blog/tags/hello', '88b'),
    exact: true
  },
  {
    path: '/blog/tags/hola',
    component: ComponentCreator('/blog/tags/hola', '3a8'),
    exact: true
  },
  {
    path: '/blog/tags/hola/page/2',
    component: ComponentCreator('/blog/tags/hola/page/2', '6de'),
    exact: true
  },
  {
    path: '/blog/tracking-network-hardware-assets-at-the-isle-of-wight-festival',
    component: ComponentCreator('/blog/tracking-network-hardware-assets-at-the-isle-of-wight-festival', '024'),
    exact: true
  },
  {
    path: '/blog/truss-connection-node-modeling',
    component: ComponentCreator('/blog/truss-connection-node-modeling', '240'),
    exact: true
  },
  {
    path: '/blog/using-data-queries-to-enhance-wildlife-connectivity',
    component: ComponentCreator('/blog/using-data-queries-to-enhance-wildlife-connectivity', 'c5a'),
    exact: true
  },
  {
    path: '/blog/vertical-farming-for-continuous-salad-production',
    component: ComponentCreator('/blog/vertical-farming-for-continuous-salad-production', 'c74'),
    exact: true
  },
  {
    path: '/blog/wireless-coverage-at-manchester-pride',
    component: ComponentCreator('/blog/wireless-coverage-at-manchester-pride', 'cfe'),
    exact: true
  },
  {
    path: '/blog/wireless-coverage-at-the-bath-festival-a-heatmap-analasis',
    component: ComponentCreator('/blog/wireless-coverage-at-the-bath-festival-a-heatmap-analasis', 'e3f'),
    exact: true
  },
  {
    path: '/markdown-page',
  ...
  {
    path: '/about',
    component: ComponentCreator('/about', '8a0'),
    routes: [
      {
        path: '/about/about',
